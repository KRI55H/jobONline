...
<body>
    <div class="container d-flex justify-content-center align-items-center" style="width: 100vh; height: 100vh;">
        <div class="container bg-dark text-light p-2" style="width: 50vh; border-radius: 4vh;">
    ...
    <?php
        ...
        if(!$login == ""){
            ...
            $query = "SELECT * FROM users where email = '$username' AND password = '$password' AND role = 'user'";
